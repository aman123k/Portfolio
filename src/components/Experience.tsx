  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "60px" }}>
        <h2
          style={{ fontSize: "clamp(30px, 4vw, 42px)", marginBottom: "16px" }}
        >
        ...
        >
          My professional track record as a Full Stack and Frontend Engineer,
          building scalable, high-performance production applications.
        </p>
      </div>
      ...
      <div className="experience-layout">
        ...
        <div className="experience-sidebar">
          ...
          <div className="sidebar-stats-card glass-panel">
            ...
            >
              Specialized in engineering full-stack products with rich visuals,
              interactive animations, and optimized load times.
            </p>
          </div>
        </div>
      </div>
